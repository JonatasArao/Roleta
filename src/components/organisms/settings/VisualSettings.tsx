...
export const VisualSettings = () => {
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-300">
      <div>
        <h3 className="text-lg font-bold text-white mb-4">Aparência Visual</h3>
        <div className="bg-[#252733] border border-slate-700 rounded-xl p-5 space-y-6">
          <div className="space-y-4">
            <label className="text-sm font-medium text-slate-300 flex items-center gap-2">Formato da Roleta</label>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              >
                ...
                <span className="font-semibold text-sm">Clássica</span>
              </button>
              <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t border-slate-700/50">
            <div className="space-y-5">
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  <label className="text-sm font-medium text-slate-300 flex items-center gap-2"><Type size={14}/> Tamanho do Texto</label>
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  <label className="text-sm font-medium text-slate-300 flex items-center gap-2"><Monitor size={14}/> Tamanho do Centro</label>
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-slate-300">Imagem Central (URL)</label>
              <div className="flex items-center bg-[#14151a] border border-slate-700 rounded-lg p-1.5 focus-within:border-blue-500 transition-colors">
                ...
                <input type="text" value={centerImage} onChange={(e) => setCenterImage(e.target.value)} placeholder="Cole o URL da imagem..." className="w-full bg-transparent text-sm text-slate-200 outline-none p-1.5" />
              </div>
              <p className="text-xs text-slate-500 mt-2">Dica: Use URLs de imagens transparentes (PNG) para um melhor resultado.</p>
            </div>
          </div>

          <div className="border-t border-slate-700/50 pt-5 space-y-4">
            <label className="text-sm font-medium text-slate-300 flex items-center gap-2"><Palette size={16}/> Paleta de Cores ({colors.length})</label>
